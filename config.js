...
//exports.rooms = 'all';
exports.rooms = ['1v1', 'groupchat-xprienzo-hydrocity', 'groupchat-sniper-debate', 'groupchat-xynix-dragonsden'];
...
exports.initCmds = ['|/avatar wally', '|/pm jrnice, im on!']; // Other commands (avatar, blockchallenges, etc)
...
*/
/*exports.groupchats['roomname'] = {
	toJoin: ['/join roomname'],
	onJoin: [''],
	onLeave: []
};*/
